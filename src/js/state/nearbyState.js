...
class Nearby {
    ...
    @action nextPage = () => {
        console.log('DEBUG: nextPage called. Page:', this.page, 'Position:', this.position)
        this.page++
        this.loading = true
        ...
        api.getNearbyMember({
            ...
            console.log('DEBUG: getNearbyMember success. Count:', latestMember.length)
            ...
            console.error('DEBUG: getNearbyMember failed:', err)
            this.loading = false
        })
    }
